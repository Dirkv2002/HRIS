/* ===========================================
   COMMUNICARE HRIS — app.js  (v10 - FIXED)
=========================================== */
...
/* FIXED: removed the duplicate () that caused the syntax error breaking login */
...
/* ===========================================
   ...
   Bypasses CORS by capturing the live DOM.
   Requires html2canvas + pdf-lib in index.html:
...
/* ===========================================
   SIGNING MODAL
   - Adobe style: scrollable dark panel
   - Document fills the entire right area (no grey gap)
   - 3-second poll for live updates (free)
   - Drag fixed: pure percentage delta
=========================================== */
async function openSigningModal(docId, assigneeId, alreadySigned, isRetrieved) {
  ...
  document.getElementById('signDocContent').innerHTML = `
    <div class="sign-layout">
      ...
      <!-- RIGHT PANEL: document fills fully, no grey gap -->
...
/* ===========================================
   DRAG FIX — pure percentage delta, no mixing
=========================================== */
function sigDragStart(e) {
  ...
  // Capture mouse start and sig start both in % space
...
/* Bulk insert + fire-and-forget = instant */
