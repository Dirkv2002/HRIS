...
async function handleLogin(e) {
  ...
  // Force sign out any existing session first to avoid session conflicts
...
async function handleSignup(e) {
  ...
  if (role === 'manager' || role === 'employee' || role === 'admin') {
    ...
    if (!dept) { showAuthMessage('Please select your department.', 'error'); return; }
  }
