...
/* ===========================================
   ...
   Detects when user arrives via reset link
   and shows the set-new-password modal
=========================================== */
(async function handlePasswordResetOnLoad() {
  ...
  if (type === 'recovery' && token) {
    ...
    // Show the reset modal immediately
...
async function submitNewPassword() {
  ...
  // Hide modal and sign out so user logs in fresh with new password
